...
export default function Signup() {
  ...
  return (
    (<div
      className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input  bg-richblack-900 dark:bg-richblack-900">
      <h2 className="font-bold text-3xl text-neutral-800 dark:text-neutral-200">
        Welcome to UnicodeHub
      </h2>
      <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
        Register on UnicodeHub  to upload  your projects
      </p>
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        <div
          ...
          <LabelInputContainer>
            ...
            <Input id="lastname" placeholder="Doe5653" type="text" />
          </LabelInputContainer>
        </div>
